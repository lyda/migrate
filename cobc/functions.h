...
COBC_DEFINE_FUNCTION (COB_CLOSE, "cob_close", 2)
COBC_DEFINE_FUNCTION (COB_DELETE, "cob_delete", 1)
COBC_DEFINE_FUNCTION (COB_DIVIDE_QUOTIENT, "cob_div_quotient", 4)
...
COBC_DEFINE_FUNCTION (COB_OPEN, "cob_open", 3)
COBC_DEFINE_FUNCTION (COB_READ, "cob_read", 1)
COBC_DEFINE_FUNCTION (COB_READ_NEXT, "cob_read_next", 1)
COBC_DEFINE_FUNCTION (COB_REWRITE, "cob_rewrite", 1)
...
COBC_DEFINE_FUNCTION (COB_WRITE, "cob_write", 1)
