...
extern struct unstring_delimited *alloc_unstring_delimited (short int all, cob_tree var);
...
extern void gen_add (cob_tree s1, cob_tree s2, int rnd);
extern void gen_subtract (cob_tree s1, cob_tree s2, int rnd);
extern void gen_multiply (cob_tree s1, cob_tree s2, cob_tree s3, int rnd);
extern void gen_divide (cob_tree s1, cob_tree s2, cob_tree s3, cob_tree s4, int rnd);
...
extern void gen_add2 (struct math_var *vl1, struct math_var *vl2, cob_tree sy1, struct math_ose *v1);
extern void gen_subtract1 (struct math_var *vl0, struct math_var *vl2, struct math_ose *v1);
extern void gen_subtract2 (struct math_var *vl1, struct math_var *vl2, cob_tree sy1, struct math_ose *v1);
...
extern void gen_goto_depending (struct list *l, cob_tree sy);
...
extern void dump_alternate_keys (cob_tree r, struct alternate_list *alt);
