...
extern void asm_call (const char *name);
extern void asm_call_1 (const char *name, cob_tree s1);
extern void asm_call_2 (const char *name, cob_tree s1, cob_tree s2);
extern void asm_call_3 (const char *name, cob_tree s1, cob_tree s2, cob_tree s3);
...
extern void proc_header (cob_tree_list using);
extern void proc_trail (cob_tree_list using);
...
extern void gen_sort_using (cob_tree f, cob_tree_list l);
extern void gen_sort_giving (cob_tree f, cob_tree_list l);
