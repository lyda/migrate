...
extern void gen_compute (struct math_var *vl1, cob_tree sy1, struct math_ose *ose);
extern void gen_add (cob_tree n1, cob_tree n2, int rnd);
extern void gen_add_to (cob_tree_list nums, struct math_var *list, struct math_ose *ose);
extern void gen_add_giving (cob_tree_list nums, struct math_var *list, struct math_ose *ose);
extern void gen_subtract_from (cob_tree_list subtrahend_list, struct math_var *list, struct math_ose *ose);
extern void gen_subtract_giving (cob_tree_list subtrahend_list, cob_tree minuend, struct math_var *list, struct math_ose *ose);
extern void gen_multiply_by (cob_tree multiplicand, struct math_var *list, struct math_ose *ose);
extern void gen_multiply_giving (cob_tree multiplicand, cob_tree multiplier, struct math_var *list, struct math_ose *ose);
extern void gen_divide_into (cob_tree divisor, struct math_var *list, struct math_ose *ose);
extern void gen_divide_giving (cob_tree divisor, cob_tree dividend, struct math_var *list, struct math_ose *ose);
extern void gen_divide_giving_remainder (cob_tree divisor, cob_tree dividend, cob_tree quotient, cob_tree remainder, int rnd, struct math_ose *ose);
